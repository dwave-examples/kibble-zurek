...
parametrize_vals = [
    (512, "512, 1024", 'SUBMITTED'),
    (2048, "512, 1024", 'EMBEDDING')
]

@pytest.mark.parametrize(
    'spins_val, cached_embedding_lengths_val, submit_state_out', 
    parametrize_vals)
...
parametrize_vals = [
    (-1, 'READY', 512, {}, False, True,
     no_update, no_update, 'ERROR', no_update, no_update, no_update),
    ('first few attempts', 'SUBMITTED', 512, {}, no_update, no_update,
    200, 0, 'SUBMITTED', no_update, no_update, no_update),
    ('first returned status', 'SUBMITTED', 512, {}, no_update, no_update,
    1000, 0, 'PENDING', no_update, no_update, no_update),
    ('1', 'PENDING', 512, {}, no_update, no_update,
    1000, 0, 'IN_PROGRESS', no_update, no_update, no_update),
    ('1', 'IN_PROGRESS', 512, {}, no_update, no_update,
    1000, 0, 'IN_PROGRESS', no_update, no_update, no_update),
    ('2', 'IN_PROGRESS', 512, {}, no_update, no_update,
    1000, 0, 'COMPLETED', no_update, no_update, no_update),
    ('2', 'COMPLETED', 512, {}, False, True,
    no_update, no_update, no_update, no_update, no_update, no_update),
    ('3', 'CANCELLED', 512, {}, False, True,
    no_update, no_update, no_update, no_update, no_update, no_update),
    ('4', 'FAILED', 512, {}, False, True,
    no_update, no_update, no_update, no_update, no_update, no_update),
    ('dummy', 'EMBEDDING', 'yes', {}, no_update, no_update,
    200, no_update, 'SUBMITTED', no_update, {'yes': {1: [10], 2: [20]}}, "yes"),
    ('dummy', 'EMBEDDING', 'no', {}, False, True,
    no_update, no_update, 'FAILED', no_update, no_update, no_update),
]

@pytest.mark.parametrize(parametrize_names, parametrize_vals)
def test_simulate_states(mocker, job_id_val, job_submit_state_in,
                         spins_val, embeddings_cached_in, btn_simulate_disabled_out, 
                         wd_job_disabled_out, wd_job_intervals_out, wd_job_n_out, 
                         job_submit_state_out, job_submit_time_out, embeddings_cached_out,
    ...
    def run_callback():
        ...
        return simulate(1, job_id_val, job_submit_state_in, before_test,
                        spins_val, 'Advantage_system4.3', embeddings_cached_in)
